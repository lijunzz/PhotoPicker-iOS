...
public struct Contact {
    ...
    public typealias AllPeoplesClosure = ([People]) -> Void
    ...
    private static func authorizationStatus(_ vc: UIViewController, closure: @escaping AuthorizationClosure) {
        ...
        case .denied:
            ...
            Alert.show(vc, title: "ContactsActionSheetTitle".language(), body: "ContactsActionSheetMessage".language(), style: .dialog, actions: [settingsAction])
        case .notDetermined:
    ...
    private static func queryAllPeoples(_ vc: UIViewController, closure: AllPeoplesClosure) {
        ...
        do {
            try store.enumerateContacts(with: request) { (contact, stop) in
                ...
                let people = People(familyName: familyName, givenName: givenName, phone: phones)
