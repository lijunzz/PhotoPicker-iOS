...
class ViewController: UIViewController {
    ...
    // 需声明成成员变量，否则将无法收到图片。
    private let imagePicker = ImagePickerUtils()
    ...
    @IBAction func showLocalNotification() {
        ...
        NotificationsUtils.local(title: "测试", body: "测试内容", time: time, categoryIdentifier: "Test", requestIdentifier: "Test-Identifier")
    }
